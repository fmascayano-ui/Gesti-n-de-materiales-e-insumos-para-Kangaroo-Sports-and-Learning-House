      ...
      {!showForm && (
          <div className="flex justify-between items-center bg-white p-6 rounded-xl shadow-sm border border-gray-100">
              ...
              <button 
                  ...
                  className="flex items-center gap-2 bg-purple-600 hover:bg-purple-700 text-white font-bold px-5 py-3 rounded-lg transition-all shadow-sm hover:shadow"
              >
                  <PlusCircle size={20} />
    ...
    <div className="min-h-screen bg-[#FAFAFA] font-sans text-gray-900 flex">
      ...
      `}>
        ...
        <nav className="flex-1 py-6 overflow-y-auto">
          ...
          <div className="px-6 mt-8 mb-2 text-xs font-bold text-gray-400 uppercase tracking-wider">Gestión</div>
